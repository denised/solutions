...
It can be run as a script ala `python create_expected_results.py <csv-file-directory>`"""
...
def create_expected_results(directory):
    """Assemble the csv files created by the export macro into an expected_results.zip file.
...
if __name__ == "__main__":
    ...
    create_expected_results(args.directory)
